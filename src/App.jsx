...
export default function App() {
  const [currentView, setCurrentView] = useState('form'); // 'form' | 'admin_login' | 'admin_dashboard'
  ...
  const handleFillSampleData = (sample) => {
    // Create mock dummy files for testing ease
  ...
  const handleStepClick = (stepId) => {
    // Only allow jump to step if previous steps are completed or going backward
